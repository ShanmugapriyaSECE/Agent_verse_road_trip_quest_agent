...
function PlanTrip({ onGenerate, isLoading }) {
  return (
    <div className="min-h-[70vh] flex items-start justify-center">
      ...
      >
        <div className="rounded-[36px] bg-[rgba(255,255,255,0.08)] border border-white/10 p-8 mb-8 shadow-2xl backdrop-blur-sm">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="space-y-3 rounded-3xl bg-[rgba(255,255,255,0.06)] p-5 shadow-2xl border border-white/10">
